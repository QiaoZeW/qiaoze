        ...
        <div class="box">
            <div :class="setClass">
                ...
                <div>
                    ...
                    <div class="orderdetail">
                        ...
                        <div class="order-right">{{payYear}}年</div>
                    </div>
                    <div class="orderdetail">
            ...
            <div class="box-detail">
                ...
                <div>
                    ...
                    <div class="orderdetail">
                        ...
                        <div class="order-right">{{proper.idType == '4'?'出生证':proper.idType == '5'?'户口本':'身份证'}}</div>
                    </div>
                    <div class="orderdetail">
                    ...
                    <div class="socialSecurity" v-if="curRiskCode == '5315'||curRiskCode == '5316'">
                        <p>是否享有基本医疗保险或公费医疗</p>
                        <p>{{ socialSecurity }}</p>
                    </div>
                </div>
            ...
            <div class="box-detail">
                ...
                <div>
                    ...
                    <div class="orderdetail" v-if="insure.idType != '4' && insure.idType != '5' && jobInfo.insureIdValidate != '3000-01-01'">
                        <div class="order-left">证件有效期</div>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.getBankList()
            if (this.curRiskCode === '5032' || this.curRiskCode === '5315' || this.curRiskCode === '5316') {
        ...
        mounted() {
            ...
            this.$app.showCustomerIntelligence((data) => {
                _this.wxPayFlag = data.wxPayFlag
                _this.$app.ifWxPay((flag) => {
                    if(flag) {
                        if(_this.wxPayFlag){
                    ...
                    console.log(_this.showWxAndBank)
        ...
        methods: {
            ...
            wxPayUrl(){
                let payUrl ;
                if(process.env.NODE_ENV === 'production'){
                    payUrl = "https://appservice.aeonlife.com.cn/appservice/payment/wxpay/jsapiPay.do"
                }else{
                    payUrl = "https://appservicetest.aeonlife.com.cn/appservice/payment/wxpay/jsapiPay.do"
                }
                return payUrl
            },
            wxPaySpecialUrl() {
            ...
            goBankBook() {
                window.location.href =
                    this.$router.siteUrl() + "/product/BankAuthorize.html?product_id=" + this.product_id;
            },
                    ...
                    successFn: data => {
                        ...
                        if (_this.agentCode) {
                            _this.successAdd =
                                ...
                                "/product/Successful.html?product_id=" + _this.product_id+
                                "&agentCode=" +
                                _this.agentCode + "&randomTime=" + _this.randomTime;
                        } else {
                            _this.successAdd =
                                _this.$router.siteUrl() +
                                `/product/Successful.html?product_id=${_this.product_id}&randomTime={_this.randomTime}`
                        }
            ...
            onBankContactIcon(){
                if (!Array.isArray(this.bankNumberData[0]) || this.bankNumberData[0].length == 0) {
                    Toast.info('暂无绑定银行卡')
                    return false
                }
            ...
            wx_jsubmit() {
                ...
                // window.location.href = "/product/orderpayments";
            },
            jsubmit() {
                let _this = this;
                if (_this.agreeConf.checked == false) {
...
<style lang="scss" scoped>
    ...
    .renew {
        ...
        li {
            ...
            .bankCardPay1 {
                background: url("../../assets/imgs/modeOfPayment/BankCardPay1.png") no-repeat 0 center;
            ...
            .weChatPay1 {
                background: url("../../assets/imgs/modeOfPayment/WeChatPay1.png") no-repeat 0 center;
        ...
        .wx_active {
            ...
            .weChatPay1 {
                background: url("../../assets/imgs/modeOfPayment/WeChatPay2.png") no-repeat 0 center;
                background-size: 0.5rem;
            }
        }
        .active {
            ...
            .bankCardPay1 {
                background: url("../../assets/imgs/modeOfPayment/BankCardPay2.png") no-repeat 0 center;
                background-size: 0.46rem;
            }
        }
    }
