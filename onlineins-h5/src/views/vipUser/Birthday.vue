<template>
    <div>
        ...
        <div class="picTitle">
            <p class="contTitle">生日福利</p>
            <p class="contDes">给会员最贴心的生日礼物</p>
        </div>
        <div class="description">
            <h3>权益说明</h3>
            <p class="wenZi parP">会员可享受每年1次的专属生日礼包，生日礼包在生日当月可在该页面领取</p>
        </div>
        <div class="rule">
            <h3> 各等级对应礼包如下：</h3>
            ...
            <table>
                <tr class="parK">
                    <th>新手上路</th>
                    <th class="solidWhite">50百佳豆</th>
                </tr>
                <tr class="parT">
                    <td>健康先锋</td>
                    <td class="solidWhite">1500百佳豆</td>
                </tr>
                <tr class="parK">
                    <td>保障达人</td>
                    <td class="solidWhite">2000百佳豆</td>
                </tr>
                <tr class="parT">
                    <td>保险专家</td>
                    <td class="solidWhite">3000百佳豆</td>
                </tr>
                <tr class="parK">
                    <td>一代宗师</td>
                    <td class="solidWhite">5500百佳豆</td>
                </tr>
            </table>
        </div>
        ...
        methods: {
            goReceive() {
                ...
                this.$app.getToken(function (userToken) {
                    ...
                    _this.$request({
                        //url: `/vip/grade/gift/2/`+'rank/'+ _this.currentLevel,
                        url: `/vip/grade/gift/2/${_this.currentLevel}`,
                        isEncript: true,
                            ...
                            if (_this.currentLevel > data.rank) {
                                ...
                                if (data.giftRecordList) {
                                    ...
                                    for (let i in data.giftRecordList) {
                                        ...
                                        //giftType==2代表生日礼包 并且 判断是否是当前等级
                                        if (item.giftType == 2 && item.giftRank == _this.currentLevel) {
                                            //标记已领取
                                            _this.floatGift = 3;
                                            return;
                                        }
                                ...
                                //判断是否可领取，1、生日是否是当前月 2、判断是否当前等级
                                if (data.birthday == '1' && _this.currentLevel == data.rank) {
                                    _this.floatGift = 4;
                                }
                            }
                        },
...
<style lang="scss" scoped>
    ...
    .picTitle {
        width: 100%;
        height: 3.4rem;
        background: url("../../assets/imgs/vip/birthday@2x.png") no-repeat left top;
