<template>
    <section @click="closeBg">
        ...
        <p class="downloadBtn" :class="{'hidden': fromPc}" @click="openApp">下载百年人寿APP</p>
        <div class="part">
            <ul>
                <li>
...
<script>
    ...
    export default {
        ...
        created () {
            ...
            this.fromPc = this.$router.query("fromPc") || '';
                ...
                this.$request({
                    ...
                    successFn: (data) => {
                        if (data && data.packageUrl) {
                            ...
                            if (this.fromPc) {
                                if (this.isAndroid) {
                                    this.downloadUrl = `https://app-package-1253426296.file.myqcloud.com/aeononline/bainian_1.1.4_2019-11-11_sites_sempc.apk`
                                }
