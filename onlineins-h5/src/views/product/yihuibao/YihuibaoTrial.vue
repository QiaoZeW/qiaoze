        ...
        <div class="content trial-mod">
            ...
            <div :class="setClass2" >
                ...
                <div class="details" ref="payEndYearMod">
                    <p>保障期限</p>
                    <ul>
                        <li data-val="10" :class="{ active : (payEndYearSelected === '1')}"
                            @click="payEndYearHandleChoose($event,'1')">10年
                        </li>
                        <li data-val="15" :class="{ active : (payEndYearSelected === '2')}"
                            @click="payEndYearHandleChoose($event,'2')">15年
                        </li>
                    </ul>
                </div>
                <div class="details" ref="insuYearMod">
                    <p>缴费年限</p>
                    <p class="parT" v-if = "payEndYearSelected === '1'">10年</p>
                    <p class="parT" v-else>15年</p>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            payEndYearHandleChoose(e, index) {
                ...
                console.log(this.payEndYearSelectVal);
