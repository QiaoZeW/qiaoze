        ...
        <div class="content trial-mod">
            ...
            <div :class="setClass2" >
                ...
                <div class="details" ref="payEndYearMod">
                    <p>保证续保年限</p>
                    <ul>
                        <li data-val="10" :class="{ active : (renewAssure === '10')}"
                            @click="renewAssureChoose($event)">10年
                        </li>
                        <li data-val="15" :class="{ active : (renewAssure === '15')}"
                            @click="renewAssureChoose($event)">15年
                        </li>
                        <li ref="amntMod" data-val="20" :class="{ active : (renewAssure === '20')}"
                            @click="renewAssureChoose($event)">20年
                        </li>
                    </ul>
                </div>
                  ...
                  <div class="payments">
                    ...
                    <ul>
                      <li
                        ...
                        @click="isPaywayChoose($event,'2')"
                      >月缴</li>
                      <li
                        data-val="N"
                        :class="{active:(payway === '1')}"
                        @click="isPaywayChoose($event,'1')"
                      >年缴</li>
                    </ul>
                  </div>
                </md-field>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 缴费年限
            renewAssureChoose(e,overAge) {
                //更新保证续保年限
                this._resetRenewAssure(parseInt(e.target.dataset.val));
                // console.log(this.overAge)
                // if (this.overAge > 55) {
                //     this.$refs.amntMod.className = "be-grey";
                // }
                this.renewAssure = e.target.dataset.val;
                this.calPAWithRule();
            },
            goCustomer() {
                if(this.isBrowser){
            ...
            calPAWithRule() {
                ...
                this.$request({
                    ...
                    successFn: (data) => {
                        ...
                        if (this.proposal.insuredInfo.age > 55) {
                            this.$refs.amntMod.className = "be-grey";
                        }
                    },
                    failFn: (data) => {
            ...
            _resetRenewAssure(val) {
                for (let index in this.proposal.policyInfoList) {
                    if (this.proposal.policyInfoList[index].renewAssureYear) {
                        this.proposal.policyInfoList[index].renewAssureYear = val
                    }
                }
            },
            ...
            onDatePickerConfirm(columnsValue) {
                ...
                if (_age > 55) {
                    ...
                    this.renewAssure="10"
                    this.$refs.amntMod.className = "outFocus";
                }
                this._resetRenewAssure(10)
                // if (this.renewAssure=="20" && _age > 55) {
                //     Toast.failed("55岁以上保证续保年限不支持20年");
                //     return
                // }
                if (_age < 18) {
