    ...
    export default {
        ...
        methods: {
            ...
            wxPayResult(){
                ...
                _this.$request({
                    url: `/wechat/wxPayResult/${_this.orderNo}`,
                    ...
                    successFn: data => {
                        ...
                        if(data.modelCode == 1){
                            window.location.href = "agent/AgentSuccessful.html?product_id=" + data.productId + "&agentCode=" + data.agentCode+ "&randomTime=" + _this.randomTime;
                        }else{
