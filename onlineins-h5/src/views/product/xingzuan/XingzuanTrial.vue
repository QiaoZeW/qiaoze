    ...
    export default {
        ...
        methods: {
            ...
            loginSuccess(userCode){
                ...
                let goHref = '';
                if(_this.agentCode){
                    goHref = _this.$router.siteUrl() +'/product/xingzuan/Question.html?product_id=' + _this.product_id + '&agentCode=' + _this.agentCode
                }else{
                    goHref = _this.$router.siteUrl() +'/product/xingzuan/Question.html?product_id=' + _this.product_id
                }
            ...
            _resetPayIntvVal(val) {
                ...
                console.log(this.proposal.policyInfoList[0].payIntv)
            },
