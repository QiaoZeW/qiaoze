    ...
    <div class="section">
        ...
        <div class="content trial-mod">
            ...
            <div :class="setClass2">
                ...
                <div class="details" ref="insuYearMod">
                    ...
                    <ul>
                        <li :data-val="item" v-for="(item, key) in insuYear"
                            :class="{ active : (insuYearSelected === key)}" v-if="item==='106A'">终身
                        </li>
                    </ul>
                </div>
                ...
                <div ref="dutyMod"
                     :class="((item.dutyCode==='5318D2'||item.dutyCode==='5909D1')&&item.choFlag!=='M')?'detailP':'detailP hide'"
                    ...
                    <ul v-if="item.riskCode === '5318' || !item.premAmnt">
                ...
                load_shence_zj_buynow(_this.shence_riskInfo, {
                    ...
                    if(_this.proposal.policyInfoList.find((item) => (item.dutyCode == '5909D1'))){
                        if(_this.agentCode){
                            ...
                            // location.href = '../' + 'healthtwice?product_id=' + _this.product_id + '&agentCode=' + _this.agentCode
                        }else{
...
//
                        ...
                        //重置被投保试算年龄
						this.minDate = new Date(this.minOrMaxBirthday(40));//最大年龄
                    ...
                    if (this.insuYearVal === 106) {
                        if (_age >= 0 && _age <= 35) {
							...
							if (this.amnt[8]) {
								...
								this.amnt = ["100000", "150000", "200000", "250000", "300000", "350000", "400000"];
							}
            ...
            showToast(n) {
               if (n === '5909D1') {
                    ...
                    this.toastInfo = '自首次恶性肿瘤确诊之日起3年后，再次罹患恶性肿瘤，包括新发、复发、转移、仍持续，给付100%基本保额'
                    Dialog.alert({content: this.toastInfo})
                }
            }
        }
