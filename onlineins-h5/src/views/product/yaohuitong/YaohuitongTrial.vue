    ...
    <div class="section">
            ...
            <div :class="setClass2">
                ...
                <div class="md-example-child md-example-child-action-sheet" style="display: block">
                    <div class="detailB" style="border-top:1px solid #e8e8e8">
                        <p>保障期限</p>
                        <p class="parT">{{ payIntvName1 }}</p>
                    </div>
                </div>
                <div class="md-example-child md-example-child-action-sheet" style="display: block">
                    <div class="detailB" style="border-top:1px solid #e8e8e8">
                        <p>缴费年限</p>
                        <p class="parT">{{ payIntvName2 }}</p>
                    </div>
                </div>
                <!-- <div class="md-example-child md-example-child-action-sheet" style="display: block">
                    <div @click="changeValue"  class="detailB" style="border-top:1px solid #e8e8e8">
                        <p>缴费方式</p>
        ...
        <div class="contentBottom">
            ...
            <p class="bottom1" ref="bottom1">
                <span class="zongHe">￥</span><span class="price">{{ proposalResult}}</span><span v-if="payIntvVal == 12" class="year"> /年</span><span v-else class="year"> /月</span>
            </p>
...
<script>
    import { DatePicker, ActionSheet, Button, Dialog, Icon, Toast ,Radio, Field, FieldItem} from 'mand-mobile'
    ...
    export default {
        ...
        methods: {
            ...
            loginSuccess(userCode){
                ...
                load_shence_zj_buynow(_this.shence_riskInfo, {
                    ...
                    if(_this.agentCode){
                        ...
                        // location.href = '../' + 'health.html?product_id=' + _this.product_id + '&agentCode=' + _this.agentCode
                    }else{
                        goHref = _this.$router.siteUrl() +'/product/Health.html?product_id=' + _this.product_id
                        // location.href = '../' + 'health.html?product_id=' + _this.product_id
                    }
                ...
                this.$request({
                    ...
                    successFn: (data) => {
                        ...
                        for (let j = 0; j < res.length; j++) {
                            ...
                            resultVal += parseFloat(res[j].prem)
            ...
            loadRiskInfo() {
                ...
                this.$request({
                    ...
                    successFn: (data) => {
                        ...
                        _this.proposal.policyInfoList[0].getLimit = 0;
            ...
            $_selected(item) {
                ...
                console.log(this.payIntvName)
                console.log(this.payIntvVal)
                this.proposal.policyInfoList[0].payIntv = this.payIntvVal = item.value
                this.calPAWithRule();
            },
            $_cancel() {
            },
