    ...
    <div class="section">
        ...
        <div class="content trial-mod">
            ...
            <div :class="setClass2">
                ...
                <div ref="dutyMod"
                     :class="((item.dutyCode==='5314D2'||item.dutyCode==='5909D1')&&item.choFlag!=='M')?'detailP':'detailP hide'"
                    ...
                    <ul v-if="item.riskCode === '5314' || !item.premAmnt">
    ...
    export default {
        ...
        methods: {
                ...
                this.$request({
                    ...
                    successFn: (data) => {
                        ...
                        for (let j = 0; j < res.length; j++) {
                            ...
                            if (res[j].dutyCode === "5314D1" || res[j].dutyCode === "5314D2") {
            ...
            insuYearHandleChoose(e, index) {
                ...
                if (this.curRiskCode === '5314') {
                    //康惠保尊享版
                    if (this.insuYearVal === 106) {
                       if (this.proposal.insuredInfo.age >= 0 && this.proposal.insuredInfo.age <= 35) {
                        ...
                        } else if (this.proposal.insuredInfo.age >= 35 && this.proposal.insuredInfo.age <= 40) {
            ...
            handleChoose(e, key, amntKey) {
                ...
                if (flagCreate >= 0) {
                    if (val == 0) {
                        //删除
                        // this.noPolicyInfoList.amnt = this.insurePolicyInfoList.amnt
                        // this.noPolicyInfoList.payEndYear = this.insurePolicyInfoList.payEndYear
                        // if (this._isCreateDuty(dutyCode) >= 0) {
                        //     return false;
                        // }
                        let temp = Object.assign({}, this.policyInfoList, temp);
                        temp.dutyCode = "5314D1";
                        temp.riskCode = "5314";
                        ...
                        // this._delCaleDuty('5314D2')
                        // this.proposal.policyInfoList.push(this.noPolicyInfoList)
                    } else {
                    ...
                    // this.insurePolicyInfoList = this.noPolicyInfoList
                    // this.insurePolicyInfoList.amnt = this.noPolicyInfoList.amnt
                    // if( this.proposal.policyInfoList.length > 1){
                        this._delCaleDuty('5314D1')
                    // }
                }
                this.calPAWithRule();
            },
            ...
            _resetCaleDuty(dutyCode) {
                ...
                if (flagCreate >= 0) {
                    ...
                    if(this.proposal.policyInfoList.length > 1) {
                        this.newPolicyinfoList = this.proposal.policyInfoList[0];
                        this.proposal.policyInfoList[1].amnt = this.newPolicyinfoList.amnt;
                    }
                }
            },
            datePickerShow() {
...
//                                this.proposal.policyInfoList[0].amnt = data.riskInfo.amnt.split('|')[0];
            ...
            showToast(n) {
               if (n === '5909D1') {
                    ...
                    this.toastInfo = '13种男性特定疾病、9种女性特定疾病、10种少儿特定疾病。等待期90天，发生特定疾病，赔偿重疾保额30%'
                    Dialog.alert({content: this.toastInfo})
                }
            }
        }
