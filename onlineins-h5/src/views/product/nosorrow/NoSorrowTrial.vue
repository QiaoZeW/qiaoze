                ...
                load_shence_zj_buynow(_this.shence_riskInfo, {
                    ...
                    if(_this.proposal.policyInfoList.find((item) => (item.dutyCode == '5909D1'))){
                        if(_this.agentCode){
                            ...
                            // location.href = '../' + 'healthtwice.html?product_id=' + _this.product_id + '&agentCode=' + _this.agentCod
                        }else{
                            goHref = _this.$router.siteUrl() +'/product/HealthTwice.html?product_id=' + _this.product_id
                            // location.href = '../' + 'healthtwice.html?product_id=' + _this.product_id
                        }
                    } else{
                        if(_this.agentCode){
            ...
            loadRiskInfo() {
                ...
                this.$request({
                    ...
                    successFn: (data) => {
                        ...
                        //重置被投保试算年龄
                        _this.minDate = new Date(this.minOrMaxBirthday(80));//最大年龄
